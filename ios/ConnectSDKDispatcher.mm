...
+ (JSCommand*) command:(NSArray*)rnCommand dispatcher:(JSCommandDispatcher*)dispatcher module:(ConnectSdk*)module
{
...
+ (JSCommandDispatcher*) dispatcherWithModule:(ConnectSdk*)module device:(ConnectableDevice*)device
{
